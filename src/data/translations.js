...
const en = {
  ...
  disclaimerTitle: "Disclaimer", disclaimerBody: "Results may vary depending on your printer, settings, paper, and cutting accuracy. Check the size and fit before attaching a skin. Use KISEKAME and any skins you create at your own risk.",
...
const ja = {
  ...
  disclaimerTitle: "免責事項", disclaimerBody: "プリンター、印刷設定、用紙、カット精度などにより、期待どおりの仕上がりにならない場合があります。スキンを装着する前にサイズとフィット感を確認してください。KISEKAMEおよび作成したスキンは自己責任でご利用ください。",
...
const ko = {
  ...
  disclaimerTitle: "면책 조항", disclaimerBody: "프린터, 인쇄 설정, 용지 및 재단 정확도에 따라 결과가 예상과 다를 수 있습니다. 스킨을 부착하기 전에 크기와 맞음새를 확인하세요. KISEKAME와 제작한 스킨은 사용자 본인의 책임으로 이용해 주세요.",
